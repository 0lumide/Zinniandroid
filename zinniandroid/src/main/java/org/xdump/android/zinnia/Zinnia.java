...
/**
 * The class that handles all methods relating to character recognition
 */
public class Zinnia {
    private Context context;

    /**Creates a zinnia object
    ...
    /**
     * This method creates a zinnia character
     * @see #zinnia_character_add(long, long, int, int)
     * @return the character object
     * <br>see the <a href="https://rawgit.com/taku910/zinnia/master/zinnia/doc/index.html">c++ documentation</a> for more details
     */
